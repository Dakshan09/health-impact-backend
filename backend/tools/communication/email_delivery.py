...
def send_reports_email(
    ...
    if not smtp_email or not smtp_password:
        print("⚠️  SMTP credentials not configured (SMTP_EMAIL / SMTP_PASSWORD missing in .env)")
    ...
    try:
        ...
        print(f"SUCCESS: Email sent to {to_address} with {len(attachments)} attachment(s)")
        return True

    except smtplib.SMTPAuthenticationError:
        print("FAILED: SMTP Authentication failed. Check SMTP_EMAIL and SMTP_PASSWORD in .env")
...
<table width="600" cellpadding="0" cellspacing="0" style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.08);">
  ...
  <tr><td style="background:linear-gradient(135deg,#1a6b3c 0%,#2e8b57 100%);padding:32px 36px;">
    ...
    <p style="color:rgba(255,255,255,.85);margin:6px 0 0;font-size:14px;">
      Prepared for <strong>{patient_name}</strong> &nbsp;·&nbsp; {datetime.now().strftime("%B %d, %Y")}
    </p>
  </td></tr>
  ...
  <tr><td style="padding:0 36px 20px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr><td style="padding:10px 14px;background:#f0fdf4;border-radius:8px;margin-bottom:8px;border:1px solid #d1fae5;">
        ...
        <p style="margin:4px 0 0 28px;color:#6b7280;font-size:12px;">Full medical analysis with risk tables and AI recommendations — share with your doctor</p>
      </td></tr>
      ...
      <tr><td style="padding:10px 14px;background:#faf5ff;border-radius:8px;margin-bottom:8px;border:1px solid #e9d5ff;">
        ...
        <p style="margin:4px 0 0 28px;color:#6b7280;font-size:12px;">Color-coded risk charts and lifestyle quality scores at a glance</p>
      </td></tr>
      <tr><td style="padding:6px 0;"></td></tr>
      <tr><td style="padding:10px 14px;background:#f0fdf4;border-radius:8px;border:1px solid #d1fae5;">
        ...
        <p style="margin:4px 0 0 28px;color:#6b7280;font-size:12px;">Personalized daily habits, milestones and weekly goals to improve your health</p>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:16px 36px;background:#fef9c3;border-top:1px solid #fde047;">
    <p style="margin:0;color:#854d0e;font-size:12px;line-height:1.6;">
      ⚠️ <strong>Medical Disclaimer:</strong> These reports are generated by an AI system for informational 
  ...
  <tr><td style="padding:20px 36px;text-align:center;">
    <p style="margin:0;color:#9ca3af;font-size:11px;">
      Generated by <strong>Health Impact Analyzer</strong> &nbsp;·&nbsp;
